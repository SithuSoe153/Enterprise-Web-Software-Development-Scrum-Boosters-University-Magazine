                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="guest-dashboard.php" class="nav-link">Home</a>
                                                </li>
                                                <li class="nav-item"><a href="about.php" class="nav-link">About</a>
                                                </li>
                                                <li class="nav-item"><a href="events.php" class="nav-link">Events</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        <li><a href="guest-profile.php"><span class="edu-icon edu-user-rounded author-log-ic"></span>My Profile</a>
                                                        </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="guest-dashboard">Home</a> <span class="bread-slash">/</span>
                                            </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>Number of Selected Contrbutions</h5>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>Percentage of selected Contributions</h5>
            ...
            <div class="container-fluid">
                <div class="col-lg-8">
                    <div class="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
                        <div class="single-review-st-hd">
                            <h2>Selected Contribution Lists</h2>
                        </div>
                        <div class="single-review-st-text">
                            ...
                            <div class="review-item-rating">
                                <a href="contribution-detail.php"><button class="btn btn-sm btn-primary login-submit-cs" type="submit">Detail</button></a>
                            </div>
                        </div>
                        <div class="single-review-st-text">
                            ...
                            <div class="review-item-rating">
                                <button class="btn btn-sm btn-primary login-submit-cs" type="submit">Detail</button>
                            </div>
                        </div>
                        <div class="single-review-st-text">
                ...
                <!-- <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="single-review-st-hd">
                                <h2>Contributions of Faculty Lists</h2>
                            </div>
                            <div class="single-review-st-text">
                                <img src="../img/notification/2.jpg" alt="">
                                <div class="review-ctn-hf">
                                ...
                                <div class="review-item-rating">
                                <button class="btn btn-sm btn-primary login-submit-cs" type="submit">Detail</button>
                                <button class="btn btn-sm btn-danger login-submit-cs" type="submit">Delete</button>
                                </div>
                            </div>
                            <div class="single-review-st-text">
                                <img src="../img/notification/3.jpg" alt="">
