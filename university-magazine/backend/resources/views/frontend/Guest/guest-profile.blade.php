                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item">
                                                    <a href="#" role="button" class="nav-link dropdown-toggle">
                                                        ...
                                                        <span class="admin-name">Welcome Guest Name</span>
                ...
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12">
                                        <h1><small><span>Your Last Login: <span>DD/MM/YYYY</span> <span>00:00:00</span>
                                                    <span>00</span> minutes ago </span></small></h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-left">
                        ...
                        <div class="profile-info-inner">
                            ...
                            <!-- </ul> -->
                            <div class="text-left">
                                <img src="../img/profile/1.jpg" width="310px" alt="" />
                            </div>
                            <div class="profile-details-hr">
                                <div class="text-left">
                                    <div>
                                        <b>Guest Name: </b> Guest Name<br>
                                        <b>Faculty Name: </b> Faculty Name<br>
                                        <b>Email Address: </b> guest@gmail.com<br>
                                        <b>Phonenumber: </b> 0912345678
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="review-content-section">
                                            <div class="row">
                                                <div class="form-group col-lg-12 ">
                                                    <input type="text" class="form-control" h
                    ...
                    <div class="col-lg-12 col-md-8 col-sm-8 col-xs-12">
                        ...
                        <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn col-lg-5">
                            <div class="review-content-section">
                                <div class="row">
                                    <div class="form-group col-lg-12">
                                        <label for="">Choose your new Faculty</label>
                                        <input type="text" class="form-control" h placeholder="Choose one">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-horizental cancel-wp pull-left form-bc-ele text-5">
                                            <button type="submit" class="btn btn-custon-four btn-primary">
                                                <i class="fa fa-check edu-checked-pro" aria-hidden="true"></i> Save
                                                Changes</button>
                                            <button type="reset" class="btn btn-custon-four btn-danger">
