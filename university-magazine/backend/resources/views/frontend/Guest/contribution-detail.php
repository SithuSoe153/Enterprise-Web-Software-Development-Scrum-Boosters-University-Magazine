                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                    <label class="login2 pull-left pull-right-pro">Student Name</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                    <label class="login2 pull-right pull-right-pro">Article:</label>
                                                                </div>
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                    <label class="login2 pull-left pull-right-pro">Article</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                    <label class="login2 pull-left pull-right-pro">Title</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                    <label class="login2 pull-left pull-right-pro">Description</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                                    <label class="login2 pull-left pull-right-pro"><a href="#"> File (Download ZIP format)/(can view)</a></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
