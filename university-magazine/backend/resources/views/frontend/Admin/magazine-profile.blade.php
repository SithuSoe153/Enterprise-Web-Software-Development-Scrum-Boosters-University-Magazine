                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn">
                            ...
                            <form action="/magazine-profile/{{ $magazine->id }}/update" method="POST">
                                @csrf
                                @method('PATCH')
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ $magazine->title }}" name="title"
                                                                {{ $isFinalClosureThisYear ? '' : 'disabled' }}>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control rounded"
                                                                    ...
                                                                    value="{{ $magazine->finalclosure_date }}"
                                                                    {{ $isFinalClosureThisYear ? '' : 'disabled' }}>
                                                                <script>
                                                                    flatpickr("#datePicker", {
                                                                        altInput: true,
                            ...
                            <form action="/magazine/{{ $magazine->id }}/destroy" method="POST">
                                @csrf
                                @method('DELETE')

                                <button type="submit" class="btn btn-custon-four btn-danger rounded col-lg-2">
