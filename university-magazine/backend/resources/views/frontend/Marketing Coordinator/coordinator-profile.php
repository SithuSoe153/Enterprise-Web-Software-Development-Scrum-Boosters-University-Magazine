                ...
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12">
                                        <h1><small><span>Your Last Login: <span>DD/MM/YYYY</span> <span>00:00:00</span> <span>00</span> minutes ago </span></small></h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-left">
                        <div class="profile-info-inner">
                            ...
                            <!-- </ul> -->
                            <div class="text-left">
                                <img src="../img/profile/1.jpg" width="305px" alt="" />
                            </div>
                            <div class="profile-details-hr">
                                <div class="text-left">
                                    <div>
                                        <b>Coordinator Name: </b> Coordinator Name<br>
                                        <b>Faculty Name: </b> Faculty Name<br>
                                        <b>Email Address: </b> Student@gmail.com<br>
                                        <b>Phonenumber: </b> 0912345678<br>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="review-content-section">
                                            <div class="row">
                                                <div class="form-group col-lg-12 ">
                                                    <input type="text" class="form-control" h placeholder="Student Name">
                                                </div>
                                                <div class="col-lg-6">
