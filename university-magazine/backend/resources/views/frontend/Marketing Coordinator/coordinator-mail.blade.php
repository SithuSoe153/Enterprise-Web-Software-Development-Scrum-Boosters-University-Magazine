                            ...
                            <div class="panel-heading hbuilt mailbox-hd">
                                <div class="text-center p-xs font-normal">
                                    <div class="input-group">
                                        <h1 class="col-md-12 text-left">Stay Connected: <span>Comment Notifications for
                                                You</span></h1>
                                    </div>
                                    <div class="input-group">
                                            ...
                                            @if ($comment['comment']->user_id !== auth()->user()->id)
                                                <tbody>
                                                    ...
                                                    <tr class="unread">
                                                        ...
                                                        {{-- <td><a
                                                                href="contribution-detail.php">{{ $comment->comment }}</a>
                                                        </td> --}}
                                                        <td class="text-right mail-date">
                                                            {{ $comment['comment']->created_at->diffForHumans() }}</td>


                                                        <td class="text-center mail-date"><a
                                                                href="/article-detail/{{ $comment['article']->id }}">&#11162;</a>
                                                        </td>
                                                    </tr>
