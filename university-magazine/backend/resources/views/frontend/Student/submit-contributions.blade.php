                                        ...
                                        <div class="review-content-section">
                                            ...
                                            <div class="i-checks pull-left">
                                                ...
                                                <label for="checkboxTerms">Agree <a href="#"
                                                        class="zoomInDown mg-t text-center" href="#" data-toggle="modal"
                                                        data-target="#zoomInDown2">Terms and Conditions</a> </label>
                                            </div>
                                                    ...
                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                        <button type="submit"
                                                            ...
                                                            <i class="fa fa-check edu-checked-pro"
                                                                aria-hidden="true"></i>
                                                            <a class="zoomInDown mg-t text-center" href="#"
                                                                data-toggle="modal" data-target="#zoomInDown1"
                                                                style="color: white;">Please Sign In</a></button>
