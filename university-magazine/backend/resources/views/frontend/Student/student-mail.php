                            ...
                            <div class="panel-heading hbuilt mailbox-hd">
                                <div class="text-center p-xs font-normal">
                                    <div class="input-group">
                                            <h1 class="col-md-4 text-left">Notifications</h1>
                                    </div>
                                    <div class="input-group">
                                        <input type="text" class="col-md-3 form-control" placeholder="Search email in your inbox..."> 
                                    ...
                                    <table class="table table-hover table-mailbox">
                                        <tbody>
                                            ...
                                            <tr class="unread">
                                                ...
                                                <td><b>Contribution Name</b><br>
                                                <small>Comment on Article Name</small> </td>
                                                <td><a href="contribution-detail.php">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a>
                                                </td>
                                                <td class="text-right mail-date">Tue, Nov 25</td>
                                                <td class="text-center mail-date"><a href="contribution-detail.php">&#11162;</a> </td>
                                            </tr>
                                            <tr class="unread">
                                                <td class="">
                                                    <div class="checkbox checkbox-single checkbox-success">
